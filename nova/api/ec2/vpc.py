...
class VpcController(object):
    ...
    def _find_subnet_in_vpc(self, context, cidr):
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum list nets err %s' % e)
        ...
        for network in network_rsp['networks']:
            ...
            try:
                ...
                raise exception.InvalidRequest('Quantum list subnets err %s' % e)
    ...
    def _get_group_uuid_from_group_id(self, context, group_id):
        ...
        try:
            ...
            for group in groups['security_groups']:
                ...
                raise exception.InvalidRequest('Quantum list sg err %s' % e)
    ...
    def describe_vpcs(self, context, **kwargs):
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum list ipam err %s' % e)
    ...
    def create_dhcp_option(self, context, **kwargs):
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum create ipam err %s' % e)
    ...
    def associate_dhcp_options(self, context, **kwargs):
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum update ipam err %s' % e)
        ...
        for ipam in ipam_rsp['ipams']:
            if ipam['fq_name'][2] == dhcp_options_id:
                try:
                    ...
                    raise exception.InvalidRequest('Quantum delete ipam err %s' % e)
    ...
    def create_subnet(self, context, **kwargs):
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum create net err %s' % e)
        ...
        try:
            ...
            raise exception.InvalidRequest('Quantum create subnet err %s' % e)
    ...
    def delete_subnet(self, context, **kwargs):
        ...
        for network in network_rsp['networks']:
            ...
            try:
                ...
                raise exception.InvalidRequest('Quantum delete net err %s' % e)
    ...
    def vpc_describe_security_groups(self, context, search_opts, 
        ...
        try:
            groups = quantum.list_security_groups(tenant_id=tenant_id)
        except Exception as e:
            raise exception.InvalidRequest(e)
